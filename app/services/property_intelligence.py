...
Integra dados de imóveis com a IA para respostas inteligentes
"""
...
class PropertyIntelligenceService:
    """Serviço que combina IA com dados imobiliários"""
    ...
    async def load_property_data(self) -> bool:
        ...
        try:
            ...
            if properties:
                ...
                # Se não há dados no Firebase, usar dados simulados
    ...
    def format_property_response(self, properties: List[Dict[str, Any]], 
    ...
    async def process_property_inquiry(self, message: str, user_id: str) -> str:
        """Processa consulta sobre imóveis"""
        try:
